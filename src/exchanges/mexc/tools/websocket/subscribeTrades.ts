...
export const subscribeTrades = {
  ...
  description:
    'Subscribe to MEXC Spot protobuf aggregated public trades for one symbol and return a short snapshot of streamed messages.',
  ...
  handler: async (input: Record<string, unknown>) => {
    ...
    return mexcSpotWsClient.snapshot({
      channel: `spot@public.aggre.deals.v3.api.pb@${interval}@${symbol}`,
      bodyField: 'publicAggreDeals',
